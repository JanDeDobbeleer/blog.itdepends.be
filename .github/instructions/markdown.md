...
2. Lists: Use bullet points or numbered lists for lists. Ensure proper
  indentation and spacing. Start a list with a blank line.
...
- Links:
  - **DO NOT** use inline style: `[Docs](https://example.com/docs)`
  - **ALWAYS USE** reference-style: `[Docs][docs]` and add at the end of the page:
