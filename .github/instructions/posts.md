...
- Use informal, conversational language that feels like talking to a colleague
...
- Call out bad practices while showing the better way
...
- Employ lists and bullet points for clarity
- Use **bold** for emphasis on key phrases or important points
...
- Use colloquialisms and informal expressions: "Hell no", "Long story short", "All the wins \\0/", "you guessed it"
...
- Share specific tool names, commands, and configurations
...
- Connect technical topics to broader themes (team dynamics, productivity, quality)
...
- Champion tools that reduce friction and increase focus
...
- Tooling choices and technical setups
- Team dynamics and leadership
- Going against the grain when it makes sense
- Practical implementations over theory

## What to Avoid

- Don't use corporate or marketing speak
- Avoid passive voice except when intentional for effect
- Don't hedge unnecessarily with qualifiers like "perhaps", "maybe", "possibly" unless expressing genuine uncertainty
- Don't write academic or overly formal prose
- Avoid being neutral when you have a strong opinion
- Don't explain things that are obvious to the target technical audience
- Avoid apologizing for opinions or strong stances

## Example Phrases that Capture the Voice

- "I love Twitter, I really do." (conversational opener)
- "Well now." (dramatic pause, expression of surprise)
- "you know **how much I love sidetracking**" (self-aware humor)
- "**The choice was obvious**." (confident assertion)
- "It depends" (acknowledging nuance)
- "Let's say I'm used to a more aggressive company culture, this seemed very friendly and efficient." (honest observation)
- "Your future self will thank you." (direct benefit statement)
- "Think of it like this:" (clear explanation signal)

## Final Note

The blog's tagline is "it depends" - embrace nuance and context while maintaining strong opinions. Write like you're explaining something important to a colleague over coffee: informed, passionate, direct, and human.
